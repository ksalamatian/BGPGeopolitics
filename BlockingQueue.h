//
// Created by Kave Salamatian on 23/11/2018.
//
...
//namespace code_machina {
    ...
    template<typename T>
    using QueueContainer = queuedetail::Container<T, queuedetail::QueueType>;

    template<typename T>
    using StackContainer = queuedetail::Container<T, queuedetail::StackType>;
    ...
    template<typename T>
    using ProducerGuard = queuedetail::Guard<T, queuedetail::ProducerType>;

    /// A type alias for Guard<T, ConsumerType>
    template<typename T>
    using ConsumerGuard = queuedetail::Guard<T, queuedetail::ConsumerType>;
...
#endif //BGPGEOPOLITICS_BLOCKINGQUEUE_H
